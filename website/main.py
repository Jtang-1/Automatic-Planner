...
if __name__ == "__main__":
    ...
    for day_itinerary in trip_itinerary_test.days_itinerary.values():
        current_day_of_week = day_itinerary.current_date_time.weekday()
        print(list([count, location.name, location.visit_minutes, day_itinerary.current_date_time.time(), location.open_times[current_day_of_week], location.close_times[current_day_of_week]] for count, location in enumerate(day_itinerary.locations)))
